...
The input to `screenshot` must be a directory containing a `.pptd` file. This command renders the `.pptd` file into images for inspecting the visual result of the pages.
